...
const I18N = {
 ru: {
  ...
  "To Do List":"Список дел","Support":"Поддержка","Notifications":"Уведомления","Archived":"Архив",
  "Restore":"Восстановить","Archive":"Архивировать","Manage Reasons":"Управлять причинами",
  "Archive Reasons":"Причины архивации","Previously Active":"Ранее активные",
  "Leads / Never Active":"Лиды / Никогда не активные","Blacklisted":"Чёрный список",
  "All Reasons":"Все причины","Select a reason…":"Выберите причину…","Reason":"Причина",
  "Comment":"Комментарий","Fixed reason — cannot be removed":"Фиксированная причина — нельзя удалить",
  "Custom Reasons":"Пользовательские причины","None.":"Нет.",
  "New reason…":"Новая причина…","Blacklist":"Чёрный список",

  "Add Staff Member":"Добавить сотрудника","Edit Staff Member":"Редактировать сотрудника",
  "Full access to everything.":"Полный доступ ко всему.",
  "CEO":"CEO","Admin":"Администратор","Manager":"Менеджер","Head Admin":"Главный администратор",
  "Teacher":"Учитель","Support Teacher":"Учитель поддержки",
  "All Staff":"Весь персонал","All Roles":"Все роли","All Teachers":"Все учителя",

  "High":"Высокий","Medium":"Средний","Low":"Низкий","Overdue":"Просрочено",
  "Due Today":"Сегодня","Due This Week":"На этой неделе","Priority":"Приоритет",
  "All Priorities":"Все приоритеты","All Due Dates":"Все сроки",
  "Title":"Заголовок","Title *":"Заголовок *","Due Date":"Срок","Due Date *":"Срок *",
  "Due Time":"Время","Due Time *":"Время *","Assign To":"Назначить",
  "Assign To *":"Назначить *","Select member…":"Выбрать участника…",
  "Edit Task":"Редактировать задачу","Delete this task?":"Удалить эту задачу?",
  "Completed":"Завершено","Add Task":"Добавить задачу",

  "By Month":"По месяцам","By Student":"По студенту","Collected":"Собрано",
  "Charged":"Начислено","Gap":"Разница","Pending":"Ожидание","Failed":"Ошибка",
  "Auto":"Авто","Cash":"Наличные","Card":"Карта","Amount":"Сумма",
  "Amount *":"Сумма *","Amount (UZS)":"Сумма (UZS)","Amount (UZS) *":"Сумма (UZS) *",
  "Payment Type":"Тип платежа","Payment Type *":"Тип платежа *",
  "Month covered":"Месяц","Month covered *":"Месяц *","Date":"Дата",
  "Edit Payment":"Редактировать платёж","Delete this payment?":"Удалить этот платёж?",
  "All Time":"Всё время","This Month":"Этот месяц","This Week":"Эта неделя",
  "Highest amount":"Наибольшая сумма","Lowest amount":"Наименьшая сумма",
  "Newest first":"Сначала новые","Oldest first":"Сначала старые",
  "Expected":"Ожидаемый","Credit (positive)":"Кредит (положительный)",
  "Debt (negative)":"Долг (отрицательный)","Debt (UZS)":"Долг (UZS)",
  "All Balances":"Все балансы",

  "Edit Lead":"Редактировать лида","Edit Student":"Редактировать студента",
  "Edit Group":"Редактировать группу","Enroll Student":"Зачислить студента",
  "Registration":"Регистрация","Waitlist":"Лист ожидания","Frozen":"Заморожен",
  "Converted":"Конвертирован","Converted to student":"Конвертирован в студента",
  "Source":"Источник","All Sources":"Все источники","Phone Numbers":"Телефоны",
  "Select new group *":"Выбрать новую группу *","Move…":"Переместить…",

  "Actor":"Актор","Created by":"Создал","All Actors":"Все акторы",
  "Assigned by Me":"Назначено мной","Assigned to":"Назначено","Select…":"Выбрать…",
  "Select priority…":"Выбрать приоритет…","Select reason…":"Выбрать причину…",

  "Description":"Описание","Note *":"Заметка *","Photo":"Фото","Theme":"Тема",
  "Duration":"Продолжительность","Duration *":"Продолжительность *",
  "Schedule Type":"Тип расписания","Schedule Type *":"Тип расписания *",
  "Start Date":"Дата начала","Start Date *":"Дата начала *",
  "Start Time":"Время начала","Start Time *":"Время начала *","Days *":"Дни *",
  "No available slots":"Нет доступных слотов","No repeat":"Без повтора",
  "Every day":"Каждый день","Every week":"Каждую неделю",
  "Every 2 weeks":"Каждые 2 недели","Every month":"Каждый месяц",
  "Native Language *":"Родной язык *","Level Name":"Название уровня",
  "Price (UZS)":"Цена (UZS)","Time":"Время","Time *":"Время *",

  "Deleted.":"Удалено.","Saved.":"Сохранено.","Updated!":"Обновлено!",
  "Student archived.":"Студент архивирован.","Lead archived.":"Лид архивирован.",
  "Error restoring.":"Ошибка восстановления.","Error archiving student.":"Ошибка архивации.",
  "Error saving.":"Ошибка сохранения.","Error deleting.":"Ошибка удаления.",
  "Error loading group.":"Ошибка загрузки группы.","Enter a reason.":"Введите причину.",
  "Enter a note.":"Введите заметку.","Enter a valid amount.":"Введите корректную сумму.",
  "Comment required for blacklist.":"Комментарий обязателен для чёрного списка.",
  "Name required.":"Имя обязательно.","Phone required.":"Телефон обязателен.",
  "Select at least one role.":"Выберите хотя бы одну роль.",
  "Password required.":"Пароль обязателен.","Student restored.":"Студент восстановлен.",
  "Call logged.":"Звонок записан.","Comment added.":"Комментарий добавлен.",
  "Attendance saved!":"Посещаемость сохранена!","Attendance saved.":"Посещаемость сохранена.",
  "Delete this comment?":"Удалить этот комментарий?","Delete this call log?":"Удалить этот звонок?",
  "Delete this session?":"Удалить эту сессию?",

  "Fined Students":"Оштрафованные студенты","Absences This Month":"Пропуски в этом месяце",
  "Absent":"Отсутствует","Final":"Финальный",
  "By A-Z":"По А-Я","By Z-A":"По Я-А","Student A→Z":"Студент А→Я",
  "Last comment":"Последний комментарий",
  "No container":"Без контейнера","Completion":"Завершение"
 },
 uz: {
  ...
  "To Do List":"Vazifalar","Support":"Qoʻllab-quvvatlash","Notifications":"Bildirishnomalar","Archived":"Arxiv",
  "Restore":"Tiklash","Archive":"Arxivlash","Manage Reasons":"Sabablarni boshqarish",
  "Archive Reasons":"Arxivlash sabablari","Previously Active":"Avval faol boʻlganlar",
  "Leads / Never Active":"Lidlar / Hech faol boʻlmaganlar","Blacklisted":"Qora roʻyxat",
  "All Reasons":"Barcha sabablar","Select a reason…":"Sabab tanlang…","Reason":"Sabab",
  "Comment":"Izoh","Fixed reason — cannot be removed":"Belgilangan sabab — oʻchirib boʻlmaydi",
  "Custom Reasons":"Maxsus sabablar","None.":"Yoʻq.",
  "New reason…":"Yangi sabab…","Blacklist":"Qora roʻyxat",

  "Add Staff Member":"Xodim qoʻshish","Edit Staff Member":"Xodimni tahrirlash",
  "Full access to everything.":"Hamma narsaga toʻliq kirish.",
  "CEO":"CEO","Admin":"Administrator","Manager":"Menejer","Head Admin":"Bosh administrator",
  "Teacher":"Oʻqituvchi","Support Teacher":"Yordamchi oʻqituvchi",
  "All Staff":"Barcha xodimlar","All Roles":"Barcha rollar","All Teachers":"Barcha oʻqituvchilar",

  "High":"Yuqori","Medium":"Oʻrta","Low":"Past","Overdue":"Muddati oʻtgan",
  "Due Today":"Bugun","Due This Week":"Shu hafta","Priority":"Muhimlik",
  "All Priorities":"Barcha muhimliklar","All Due Dates":"Barcha muddatlar",
  "Title":"Sarlavha","Title *":"Sarlavha *","Due Date":"Muddat","Due Date *":"Muddat *",
  "Due Time":"Vaqt","Due Time *":"Vaqt *","Assign To":"Tayinlash",
  "Assign To *":"Tayinlash *","Select member…":"Aʼzo tanlang…",
  "Edit Task":"Vazifani tahrirlash","Delete this task?":"Ushbu vazifani oʻchirish?",
  "Completed":"Bajarildi","Add Task":"Vazifa qoʻshish",

  "By Month":"Oy boʻyicha","By Student":"Oʻquvchi boʻyicha","Collected":"Yigʻilgan",
  "Charged":"Hisoblangan","Gap":"Farq","Pending":"Kutilmoqda","Failed":"Xato",
  "Auto":"Avto","Cash":"Naqd","Card":"Karta","Amount":"Miqdor",
  "Amount *":"Miqdor *","Amount (UZS)":"Miqdor (UZS)","Amount (UZS) *":"Miqdor (UZS) *",
  "Payment Type":"Toʻlov turi","Payment Type *":"Toʻlov turi *",
  "Month covered":"Oy","Month covered *":"Oy *","Date":"Sana",
  "Edit Payment":"Toʻlovni tahrirlash","Delete this payment?":"Ushbu toʻlovni oʻchirish?",
  "All Time":"Hammasi","This Month":"Shu oy","This Week":"Shu hafta",
  "Highest amount":"Eng yuqori miqdor","Lowest amount":"Eng past miqdor",
  "Newest first":"Avval yangi","Oldest first":"Avval eski",
  "Expected":"Kutilgan","Credit (positive)":"Kredit (musbat)",
  "Debt (negative)":"Qarz (manfiy)","Debt (UZS)":"Qarz (UZS)",
  "All Balances":"Barcha balanslar",

  "Edit Lead":"Lidni tahrirlash","Edit Student":"Oʻquvchini tahrirlash",
  "Edit Group":"Guruhni tahrirlash","Enroll Student":"Oʻquvchi qoʻshish",
  "Registration":"Roʻyxatdan oʻtish","Waitlist":"Navbat","Frozen":"Muzlatilgan",
  "Converted":"Oʻtkazilgan","Converted to student":"Oʻquvchiga oʻtkazilgan",
  "Source":"Manba","All Sources":"Barcha manbalar","Phone Numbers":"Telefon raqamlar",
  "Select new group *":"Yangi guruh tanlang *","Move…":"Koʻchirish…",

  "Actor":"Ijrochi","Created by":"Yaratuvchi","All Actors":"Barcha ijrochilar",
  "Assigned by Me":"Men tayinlaganlar","Assigned to":"Tayinlangan","Select…":"Tanlang…",
  "Select priority…":"Muhimlikni tanlang…","Select reason…":"Sabab tanlang…",

  "Description":"Tavsif","Note *":"Izoh *","Photo":"Rasm","Theme":"Mavzu",
  "Duration":"Davomiyligi","Duration *":"Davomiyligi *",
  "Schedule Type":"Jadval turi","Schedule Type *":"Jadval turi *",
  "Start Date":"Boshlanish sanasi","Start Date *":"Boshlanish sanasi *",
  "Start Time":"Boshlanish vaqti","Start Time *":"Boshlanish vaqti *","Days *":"Kunlar *",
  "No available slots":"Boʻsh joy yoʻq","No repeat":"Takrorlanmaydi",
  "Every day":"Har kuni","Every week":"Har hafta",
  "Every 2 weeks":"Har 2 haftada","Every month":"Har oy",
  "Native Language *":"Ona tili *","Level Name":"Daraja nomi",
  "Price (UZS)":"Narx (UZS)","Time":"Vaqt","Time *":"Vaqt *",

  "Deleted.":"Oʻchirildi.","Saved.":"Saqlandi.","Updated!":"Yangilandi!",
  "Student archived.":"Oʻquvchi arxivlandi.","Lead archived.":"Lid arxivlandi.",
  "Error restoring.":"Tiklashda xato.","Error archiving student.":"Arxivlashda xato.",
  "Error saving.":"Saqlashda xato.","Error deleting.":"Oʻchirishda xato.",
  "Error loading group.":"Guruhni yuklashda xato.","Enter a reason.":"Sabab kiriting.",
  "Enter a note.":"Izoh kiriting.","Enter a valid amount.":"Toʻgʻri miqdor kiriting.",
  "Comment required for blacklist.":"Qora roʻyxat uchun izoh talab qilinadi.",
  "Name required.":"Ism talab qilinadi.","Phone required.":"Telefon talab qilinadi.",
  "Select at least one role.":"Kamida bitta rol tanlang.",
  "Password required.":"Parol talab qilinadi.","Student restored.":"Oʻquvchi tiklandi.",
  "Call logged.":"Qoʻngʻiroq qayd etildi.","Comment added.":"Izoh qoʻshildi.",
  "Attendance saved!":"Davomat saqlandi!","Attendance saved.":"Davomat saqlandi.",
  "Delete this comment?":"Ushbu izohni oʻchirish?","Delete this call log?":"Ushbu qoʻngʻiroqni oʻchirish?",
  "Delete this session?":"Ushbu sessiyani oʻchirish?",

  "Fined Students":"Jarimali oʻquvchilar","Absences This Month":"Shu oydagi qoʻqqislar",
  "Absent":"Yoʻq","Final":"Final",
  "By A-Z":"A-Z boʻyicha","By Z-A":"Z-A boʻyicha","Student A→Z":"Oʻquvchi A→Z",
  "Last comment":"Oxirgi izoh",
  "No container":"Konteyner yoʻq","Completion":"Yakunlash"
 }
};
